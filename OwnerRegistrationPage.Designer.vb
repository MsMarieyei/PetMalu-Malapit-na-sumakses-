...
Partial Class OwnerRegistrationPage
    ...
    Private Sub InitializeComponent()
        ...
        ' PicBoxClient
        ' 
        PicBoxClient.BackColor = Color.DarkCyan
        PicBoxClient.Location = New Point(1341, 346)
        ...
        ' BtnUploadPhoto
        ' 
        BtnUploadPhoto.BackColor = Color.CadetBlue
        ...
        BtnUploadPhoto.Location = New Point(1403, 703)
        ...
        Label2.Location = New Point(282, 407)
        Label2.Name = "Label2"
        ...
        Label3.Location = New Point(312, 505)
        Label3.Name = "Label3"
        ...
        Label4.Location = New Point(387, 577)
        Label4.Name = "Label4"
        ...
        Label5.Location = New Point(329, 700)
        Label5.Name = "Label5"
        ...
        Label6.Location = New Point(344, 801)
        Label6.Name = "Label6"
        ...
        ' TxtAddress
        ' 
        TxtAddress.BackColor = Color.YellowGreen
        ...
        Label7.Location = New Point(941, 232)
        Label7.Name = "Label7"
