...
Partial Class PetRegistrationPage
    ...
    Private Sub InitializeComponent()
        ...
        Label12.Font = New Font("Bookman Old Style", 48.0F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        Label12.ForeColor = Color.FromArgb(CByte(0), CByte(64), CByte(64))
        Label12.Location = New Point(831, 198)
        Label12.Name = "Label12"
        Label12.Size = New Size(702, 93)
        Label12.TabIndex = 30
        ...
        TxtName.Font = New Font("Arial Rounded MT Bold", 24.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
